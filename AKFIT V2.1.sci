...
// Leitura dos dados
[n,isotopoSuperior,EgamaSuperior,IN,epsilon,sigmaEps,Er,sigErPorcento,ApCd,sigmaApCd,ApSCd,sigmaApSCd,Rcd,sigmaRcd, k0,sigk0Porcento,Fcd,sigmaFcd,Gepi,sigmaGepi,Gth,sigmaGth,I0,sigI0Porcento,S0,sigS0Porcento,Q0,sigmaQ0, idouro] = mfscanf(-1,entrada,"%s %lg %i %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %i");

[nAu,isotopoSuperiorAu,EgamaSuperiorAu,INAu,epsilonAu,sigmaEpsAu,ErAu,sigErPorcentoAu,ApCdAu,sigmaApCdAu,ApSCdAu,sigmaApSCdAu,RcdAu,sigmaRcdAu, k0Au,sigk0PorcentoAu,FcdAu,sigmaFcdAu,GepiAu,sigmaGepiAu,GthAu,sigmaGthAu,I0Au,sigI0PorcentoAu,S0Au,sigS0PorcentoAu,Q0Au,sigmaQ0Au] = mfscanf(-1,entradaAu,"%s %lg %i %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg %lg");
...
// ---- Cabeçalho da tabela 
cabecalho="Isotopo Egama IN   Efic   sigma     Eres     sig%    Asp_Cd    sigma       Asp      sigma    Rcd  sigma     k0   sig%   Fcd     sig     Gepi     sigma     Gth    sigma      I0    sig%   sigma0 sig%     Q0       sigma      idouro";
// Tabela de entrada
Tab = [EgamaSuperior IN epsilon sigmaEps Er sigErPorcento ApCd sigmaApCd ApSCd sigmaApSCd Rcd sigmaRcd k0 sigk0Porcento Fcd sigmaFcd Gepi sigmaGepi Gth sigmaGth I0 sigI0Porcento S0 sigS0Porcento Q0 sigmaQ0 idouro];
...
formato="%5s %7.2f %2i %8.2e %7.2e  %7.2f %5.1f  %10.4e %7.2e  %10.4e %7.2e %6.2f %4.2f %7.2e %4.2f  %6.4f %6.4f %9.6f %8.5f %8.5f %8.5f %8.3f %4.1f %8.3f %4.1f %10.6f %10.6f %2i"; 

for i=1:NGamas
 StrDados(i) =sprintf(formato,isotopoSuperior(i),Tab(i,1),Tab(i,2),Tab(i,3),Tab(i,4),Tab(i,5),Tab(i,6),Tab(i,7),Tab(i,8),Tab(i,9),Tab(i,10),Tab(i,11),Tab(i,12),Tab(i,13),Tab(i,14),Tab(i,15),Tab(i,16),Tab(i,17),Tab(i,18),Tab(i,19),Tab(i,20),Tab(i,21),Tab(i,22),Tab(i,23),Tab(i,24),Tab(i,25),Tab(i,26),Tab(i,27));
end;
...
//Ysuperior()=log(ApCd./Q0./epsilon./Fcd./Gepi);
//
