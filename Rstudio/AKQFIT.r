...
#Ymedio com ouro
dYmAspauexp = D(expression(((FCdau * (Aspau / AspCdau) - 1) * (Gth * Gepiau)) / ((FCd * (Asp / AspCd) - 1) * (Gthau * Gepi))), 'Aspau')
...
dYmGthau = eval(-(((FCdau[idouro] * (Aspau[idouro]/AspCdau[idouro]) - 1) * (Gth * Gepiau[idouro])) * ((FCd * (Asp/AspCd) - 1) * Gepi)/((FCd * (Asp/AspCd) - 1) * (Gthau[idouro] * Gepi))^2))
...
cols2b = 2 * log(Eres) * log((((AQ0 - 0.429)/Eres^Aalfa) + (0.429/((2 * Aalfa + 1) * 0.55^Aalfa)))) - 2 * Aalfa * log(Eres) * ((0.429 * (2 * 0.55^Aalfa + (2 * Aalfa + 1) * (0.55^Aalfa * log(0.55)))/((2 * Aalfa + 1) * 0.55^Aalfa)^2 + (AQ0 - 0.429) * (Eres^Aalfa * log(Eres))/(Eres^Aalfa)^2)/(((AQ0 - 0.429)/Eres^Aalfa) + (0.429/((2 * Aalfa + 1) * 0.55^Aalfa))))
...
colm2b = -(((0.429 * (2 * 0.55^Aalfa + (2 * Aalfa + 1) * (0.55^Aalfa * log(0.55)))/((2 * Aalfa + 1) * 0.55^Aalfa)^2 + (AQ0 - 0.429) * (Eres^Aalfa * log(Eres))/(Eres^Aalfa)^2)/(((Q0au - 0.429)/Eresau^Aalfa) + (0.429/((2 * Aalfa + 1) * 0.55^Aalfa))) - (((AQ0 - 0.429)/Eres^Aalfa) + (0.429/((2 * Aalfa + 1) * 0.55^Aalfa))) * (0.429 * (2 * 0.55^Aalfa + (2 * Aalfa + 1) * (0.55^Aalfa * log(0.55)))/((2 * Aalfa + 1) * 0.55^Aalfa)^2 + (Q0au - 0.429) * (Eresau^Aalfa * log(Eresau))/(Eresau^Aalfa)^2)/(((Q0au - 0.429)/Eresau^Aalfa) + (0.429/((2 * Aalfa + 1) * 0.55^Aalfa)))^2)/((((AQ0 - 0.429)/Eres^Aalfa) + (0.429/((2 * Aalfa + 1) * 0.55^Aalfa)))/(((Q0au - 0.429)/Eresau^Aalfa) + (0.429/((2 * Aalfa + 1) * 0.55^Aalfa)))))
coli2 = coli = rep(0, N)
...
colm3b = 1/Eres^Aalfa/(((Q0au - 0.429)/Eresau^Aalfa) + (0.429/((2 * Aalfa + 1) * 0.55^Aalfa)))/((((AQ0 - 0.429)/Eres^Aalfa) + (0.429/((2 * Aalfa + 1) * 0.55^Aalfa)))/(((Q0au - 0.429)/Eresau^Aalfa) + (0.429/((2 * Aalfa + 1) * 0.55^Aalfa))))
